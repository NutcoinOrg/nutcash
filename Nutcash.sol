...
// File: @openzeppelin/contracts@5.0.2/token/ERC721/utils/ERC721Holder.sol
...
/// When/if NCASH supply reaches 21M max supply, staking rewards are paused and resumed when/if supply decreases due to NCASH burning.
